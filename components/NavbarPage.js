...
export default function NavbarPage(props) {
    ...
    return (
        ...
        <div class="container">
            ...
            <div style={{marginTop: 2}}> <Link href="/" style={{textDecoration: 0, color: "black"}}>Notelite</Link> / [{props.uemail}] / [<Link style={{textDecoration: 0, color: "black"}} href={`/notebook/${props.nbid}`}>{props.nbname}</Link>] {props.title && (<>/ [</>)}{props.title}{props.title && (<>]</>)}</div>        
